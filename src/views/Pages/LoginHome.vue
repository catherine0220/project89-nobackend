    ...
    <div class="types-container flex justify-center h-[230px] pb-15 pt-10">
      <div class="w-[1200px] flex gap-5">
        <div v-for="(item, index) in typesItems" :key="index" class="mr-[0px] last:mr-0">
          <div
            class="w-[187px] h-[220px] bg-cover bg-center flex flex-col items-center justify-center pb-8 rounded-2xl cursor-pointer"
          ...
          >
            <img
              :src="item.icon"
              alt="icon"
              class="w-full h-[210px] mx-auto transition-transform duration-400 hover:-translate-y-2"
            />
